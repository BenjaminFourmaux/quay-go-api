...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/user/robots/{robot_shortname}/federation": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
    ...
    "definitions": {
        ...
        "Dto.RobotPermission": {
            ...
            "properties": {
                "repository": {
                    "$ref": "#/definitions/Dto.RobotPermissionRepository"
                },
                "role": {
                    "type": "string"
                }
    ...
    "tags": [
        ...
        {
            "description": "Manage the manifest of a repository",
            "name": "Manifest"
        },
        {
        ...
        {
            "description": "Create, list and manage and organization's teams",
            "name": "Team"
        },
        {
        ...
        {
            "description": "Get user, team or organization avatar",
            "name": "Avatar"
        }
    ],
    "externalDocs": {
        "description": "Wiki",
        "url": "https://github.com/BenjaminFourmaux/quay-go-api/wiki"
    }
}`
